# Summary – aktuální plán cesty

## Přehled
15denní cesta Vietnamem ze severu na jih pro 2 osoby.
Přílet Hanoi 6. 4. 2026, odlet Ho Chi Minh City 20. 4. 2026.

## Itinerář v bodech

| Dny | Místo | Stručný popis |
|-----|-------|---------------|
| 1–3 | **Hanoi** | Old Quarter, Ho Chi Minh Mausoleum, Chrám literatury, West Lake, Vietnam Museum of Ethnology |
...
- Ninh Binh → Hue: **noční vlak** (soft sleeper) ← 1. lůžko
...
- ✅ itinerary.html – 15denní itinerář (day cards)
- ✅ transport.html – přesuny, timeline, tabulka, tipy
- ✅ food.html – jídlo podle regionů (sever/střed/jih)
- ✅ tips.html – peníze, SIM, zdraví, bezpečnost, klima, fráze
- ✅ style.css – plný responsivní design
- ✅ script.js – hamburger menu, aktivní nav, odpočítávání
